...
const candidateProfile: CandidateProfile = {
  name: 'Alex',
  experience_years: 6,
  skills: ['python', 'system design', 'distributed systems', 'cloud infrastructure'],
  projects: ['multi-region deployment platform', 'real-time event ingestion pipeline'],
  education: 'B.Tech in Computer Science',
};

const jobProfile: JobProfile = {
  role: 'Lead Systems Engineer',
  company: 'PlacedOn Demo',
  level: 'senior',
  required_skills: ['python', 'system design', 'distributed systems'],
  preferred_skills: ['observability', 'incident management'],
};
